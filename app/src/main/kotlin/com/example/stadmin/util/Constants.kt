package com.example.stadmin.util

object Constants {

    const val TAG = "TAG"

    val BIBLE_BOOKS_EN = listOf(
    ...
    val BIBLE_BOOKS_SV = listOf(
        "1 Moseboken", "2 Moseboken", "3 Moseboken", "4 Moseboken", "5 Moseboken",
        "Josua", "Domarboken", "Rut", "1 Samuelsboken", "2 Samuelsboken",
        "1 Kungaboken", "2 Kungaboken", "1 Krönikeboken", "2 Krönikeboken",
        "Esra", "Nehemja", "Ester", "Job", "Psaltaren", "Ordspråksboken",
        "Predikaren", "Höga Visan", "Jesaja", "Jeremia",
        "Klagovisorna", "Hesekiel", "Daniel", "Hosea", "Joel", "Amos",
        "Obadja", "Jona", "Mika", "Nahum", "Habackuk", "Sefanja",
        "Haggai", "Sakarja", "Malaki",
        // Nya Testamentet
        "Matteus", "Markus", "Lukas", "Johannes", "Apostlagärningarna", "Romarbrevet",
        "1 Korinthierbrevet", "2 Korinthierbrevet", "Galaterbrevet", "Efesierbrevet",
        "Filipperbrevet", "Kolosserbrevet", "1 Thessalonikerbrevet", "2 Thessalonikerbrevet",
        "1 Timotheosbrevet", "2 Timotheosbrevet", "Titusbrevet", "Filemonbrevet", "Hebreerbrevet",
        "Jakobsbrevet", "1 Petrusbrevet", "2 Petrusbrevet", "1 Johannesbrevet", "2 Johannesbrevet", "3 Johannesbrevet",
        "Judasbrevet", "Uppenbarelseboken"
    )
